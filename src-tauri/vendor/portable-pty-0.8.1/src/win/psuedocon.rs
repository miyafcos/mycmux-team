...
impl PsuedoCon {
    ...
    pub fn spawn_command(&self, cmd: CommandBuilder) -> anyhow::Result<WinChild> {
        ...
        // CREATE_NO_WINDOW and DETACHED_PROCESS both break interactive launcher
        // startup under ConPTY. Hide the host window via STARTUPINFO while
        // keeping the child attached to the pseudo console.
