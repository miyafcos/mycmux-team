...
## [0.19.2-lite.1] - 2026-07-16

master v0.19.2 へ全量同期し、Buddy 以外を完全同一化したリリース。

- Sync: v0.11 以降のファイルサイドバー、パスジャンプ、セーブポイント、usage 監視、socket API / `pane.spawn` を含む全機能を反映。
- Lite: Buddy なしの構成は据え置き。
