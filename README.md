...
最終更新: 2026-08-27 (対象バージョン v0.57.0)。この README で分からないことは GitHub の Issues か [docs/README.md](docs/README.md) へ。
