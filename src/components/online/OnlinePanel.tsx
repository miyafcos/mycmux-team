...
const styles: Record<string, React.CSSProperties> = {
  ...
  savedChipPublished: { marginLeft: "auto", flexShrink: 0, color: "var(--cmux-accent-text)", fontSize: 11, whiteSpace: "nowrap" },
  statusDotWorking: {
    width: 7,
    height: 7,
    borderRadius: "50%",
  ...
  recordCurrentBadge: { flexShrink: 0, padding: "1px 5px", borderRadius: 9, fontSize: 11, color: "var(--cmux-accent-text)", border: "1px solid currentColor" },
  ...
  receivedBadge: { flexShrink: 0, padding: "1px 5px", borderRadius: 9, fontSize: 11, color: "var(--cmux-accent-text)", border: "1px solid currentColor" },
  openHereBadge: {
    padding: "1px 5px",
    borderRadius: 9,
    fontSize: 11,
  ...
  pinIconButtonActive: { color: "var(--cmux-accent-text)", background: "color-mix(in srgb, var(--cmux-accent) 12%, transparent)" },
