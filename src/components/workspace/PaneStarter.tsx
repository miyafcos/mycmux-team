const START_OPTIONS = [
  ...
  { id: "codex", label: "2. Codex" },
  { id: "claude-codex", label: "3. claude-codex" },
  { id: "claude-dangerous", label: "4. Claude Code (dangerous)" },
  { id: "codex-dangerous", label: "5. Codex (dangerous)" },
  { id: "claude-codex-dangerous", label: "6. claude-codex (dangerous)" },
